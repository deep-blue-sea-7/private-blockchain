...
class BlockchainController {
  ...
  // Endpoint that allows users to request Ownership of a Wallet address (POST Endpoint)
  requestOwnership() {
  ...
  // Endpoint that allows Submit a Star, you first need to `requestOwnership` to have the message (POST endpoint)
  submitStar() {
